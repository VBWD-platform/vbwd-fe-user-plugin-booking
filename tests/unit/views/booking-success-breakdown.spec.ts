/**
 * S85.4 phase-2 — BookingSuccess renders a totals-level <PriceBreakdown> built
...
describe('BookingSuccess — totals breakdown (S85.4)', () => {
  beforeEach(() => {
    mockGet.mockReset();
  });

  it('renders net / tax-total / gross from persisted invoice fields', async () => {
    ...
    expect(wrapper.find('[data-testid="booking-breakdown"]').exists()).toBe(true);
